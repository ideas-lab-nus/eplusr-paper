...
Title <- "Resilience of different technologies towards climate change for Singapore"
```

# resilience

<!-- badges: start -->
[![R build status](https://github.com/ideas-lab-nus/resilience/workflows/build-paper/badge.svg)](https://github.com/ideas-lab-nus/resilience/actions)
<!-- badges: end -->
...
Or you can install this compendium as an R package, resilience, from GitHub with:
