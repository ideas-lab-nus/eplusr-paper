...
cols <- c("Semantic API", "Support optimization", "Data extraction", "Post-processing capabilities")
...
compare %>%
    ...
    kableExtra::column_spec(9, "1.5cm") %>%
    kableExtra::column_spec(10, "1.6cm") %>%
    kableExtra::column_spec(11, "1.6cm") %>%
    kableExtra::add_footnote(threeparttable = TRUE, notation = "number", c(
        ...
        # Data extraction
        "Features of extracting further customized summary data, instead of solely based on EnergyPlus built-in functionalities",
